<?php if (isset($_POST['edit'])) {
    ...
    $data = [$sku, $name, $purchase_price, $sell_price, $stock, $min_stock, $_GET['id']];
    $update = $pdo->prepare("UPDATE product SET sku=?, name=?, purchase_price=?, sell_price=?, stock=?, min_stock=? WHERE id=?");
    $update->execute($data);
    header("Location: dashboard.php?url=product/product");
}
$product = $pdo->query("SELECT * FROM product WHERE id='$_GET[id]'")->fetch(PDO::FETCH_ASSOC); ?>
            ...
            <div class="container-fluid px-5 py-2">
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-footer my-4">
                        <a href="dashboard.php?url=product/product" type="button" class="btn btn-secondary">Cancel</a>
